  ...
  <div class="page-registration">
    <div class="registration_block">
      ...
      <form>
        ...
        <div class="form-group-item">
          ...
          <input id="fuul_name" type="text" v-model="full_name" required />
        </div>
        <div class="form-group-item">
        ...
        <div class="form-group-item">
          ...
          <button class="btn-continue" @click.prevent="register">
            Register
          </button>
        </div>
      </form>
    ...
    <div class="no-register">
      <span
        ...
        <router-link to="/login"><a href="#">Log in</a></router-link></span
      >
    </div>
  </div>
</template>
